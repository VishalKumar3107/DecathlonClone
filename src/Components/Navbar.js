  ...
  return (
    <div className="Navbar">
      ...
      <div className="Navbar-pin" style={{ margin: "0px 30px" }}>
        ...
        {user ? <p className="Navbar-cart-text" style={{marginTop:'10px'}} >{user.email}</p>: <p className="Navbar-cart-text" style={{ marginTop: "10px" }}>
      ...
      <div className={`navbar-menu ${menuVisible ? 'show' : ''}`}>
        <div className="Navbar-user">
          ...
          <div className="Navbar-cart-text-container">
            {user ? (
                      <p className="Navbar-cart-text" onClick={handlesignOut}>Sign Out</p>
                    ) : (
                      <p className="Navbar-cart-text" onClick={openSigninOverlay}>Sign In</p>
                    )}
          </div>
        </div>
        ...
        zIndex: 9999,}}
        >
          <div className="overlay-signinbox">
          <Auth signinVisible={signinVisible} setSigninVisible={setSigninVisible} />
          <button className="close-button" onClick={closeSigninOverlay}>
            Close
          </button>
            </div>
        </div>
